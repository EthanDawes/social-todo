...
<div class="tumblr-container bg-tumblr-blue min-h-screen">
  <!-- Sidebar -->
  <div class="tumblr-sidebar fixed left-0 top-0 w-80 h-full bg-tumblr-blue p-6 overflow-y-auto">
    <!-- Tumblr Logo -->
    <div class="mb-8">
      <h1 class="text-white text-4xl font-bold tracking-tight">tumblr</h1>
    </div>

    <!-- Navigation -->
    <nav class="space-y-4 mb-8">
      <a href="#" class="flex items-center space-x-3 text-white hover:text-blue-200 transition-colors py-2">
      ...
      <a href="#" class="flex items-center space-x-3 text-white hover:text-blue-200 transition-colors py-2">
        ...
        <span class="text-sm text-blue-200">(6/12)</span>
      </a>
    </nav>

    <!-- Action Buttons -->
    <div class="space-y-3">
      <button class="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-lg transition-colors">
        Sign up
      </button>
      <button class="w-full border border-white text-white hover:bg-white hover:text-tumblr-blue font-bold py-3 px-6 rounded-lg transition-colors">
        Log in
      </button>
    </div>
    ...
    <div class="mt-8">
      <div class="relative">
        <input 
          ...
          class="w-full bg-blue-800 text-white placeholder-blue-300 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
        />
  ...
  <div class="tumblr-feed ml-80 max-w-xl mx-auto bg-white min-h-screen">
    ...
    {#each postsArray as post (post.id)}
      <article class="tumblr-post bg-white rounded-xl shadow-sm border border-gray-200 mb-4 overflow-hidden hover:shadow-md transition-shadow">
      <!-- Avatar and Username -->
      <div class="flex items-start p-4 pb-0">
        <div class="w-12 h-12 rounded-sm bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center mr-3 flex-shrink-0">
          <span class="text-white font-bold text-sm">AI</span>
        </div>
        <div class="flex-1 min-w-0">
          <div class="flex items-baseline">
            <h3 class="font-bold text-lg text-black mr-2">ai-assistant</h3>
            <span class="text-sm text-gray-600">• {formatModel(post.model)}</span>
          </div>
      ...
      <div class="px-4 pb-4">
        <div class="flex items-center justify-between text-sm">
          ...
          <div class="flex items-center space-x-3">
            <!-- Reblog icon -->
            <button class="text-gray-500 hover:text-green-600 transition-colors p-1">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"/>
              </svg>
            </button>
            <!-- Heart icon -->
            <button class="text-gray-500 hover:text-red-500 transition-colors p-1">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
